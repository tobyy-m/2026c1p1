...
import ar.edu.unahur.obj2.agenciaViajes.decoradores.UpgradeHotel;
import ar.edu.unahur.obj2.agenciaViajes.paquetes.IPaquete;

public class GuiaConUpgradeDeHotelYTrasladoVIP implements IEstrategiaComercial{

    @Override
    public IPaquete agregarExtra(IPaquete paquete) {
        return new Guia(new UpgradeHotel(new TrasladoVIP(paquete)));
    }
